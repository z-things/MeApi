...
function MExpress(conx, uuid, token, configurator) {
    ...
    this.listen = function () {
        ...
        //https
        var options = {
            pfx: fs.readFileSync(path.join(__dirname, './214055202440411.pfx')),
            passphrase: '214055202440411'
        };
        var httpsServer = https.createServer(options, app).listen(self.configurator.getConf("self.listen_port.https"), function () {
